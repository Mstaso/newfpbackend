...
u1 = User.create(username: Faker::Name.name, password_digest: "data", email: Faker::Internet.email, profile_image:"https://images.pexels.com/photos/428364/pexels-photo-428364.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500", cover_photo: backgrounds.sample, description: Faker::Lorem.paragraph(2))
u2 = User.create(username: Faker::Name.name, password_digest: "data", email: Faker::Internet.email, profile_image:"https://media.istockphoto.com/photos/portrait-of-a-girl-picture-id938709362?k=6&m=938709362&s=612x612&w=0&h=mUQAOuFjTUhvykTbkpXXERePajEWvVqOM2tR3gwS3II=", cover_photo: backgrounds.sample, description: Faker::Lorem.paragraph(2))
u3 = User.create(username: Faker::Name.name, password_digest: "data", email: Faker::Internet.email, profile_image:"https://images.pexels.com/photos/2027821/pexels-photo-2027821.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260", cover_photo: backgrounds.sample, description: Faker::Lorem.paragraph(2))
